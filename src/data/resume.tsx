...
export const DATA = {
  ...
  locationLink: "",
  description:
    "Senior Software engineer building efficient, user-focused solutions with a passion for innovation and excellence",
  summary:
    "Senior Software Engineer specializing in modern JavaScript frameworks and cloud-native architecture. Skilled in building highly scalable frontend systems using Vue.js, Nuxt.js, React.js, and TypeScript, backed by strong experience with AWS deployments, load optimized architecture, CI/CD automation, version control strategies, and modular monorepo patterns. Demonstrated ability to lead feature development, optimize performance, and deliver maintainable, production-ready solutions across distributed teams. Focused on engineering excellence, system reliability, and improving frontend performance at scale.",
  avatarUrl: "/me.jpg",
  skills: [
    "HTML/CSS",
    "Javascript",
